...
// bellow we're just making it clear by setting the type after the closing parenthesis ('void', because it deosn't return anything).
...
// but here it doesn't, because the 'printResult()' func doesn't receive 2 numbers as argments and it also doens't return a number.
